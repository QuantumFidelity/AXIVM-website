...
export const SvgPlusIconBold: React.FC = () => (
 <SvgBold as="svg" viewBox="0 0 24 24" stroke="currentColor" fill="none">
   <path
     strokeLinecap="round"
...
export const SvgMinusLongBoldIcon: React.FC = () => (
 <SvgBold as="svg" viewBox="0 0 20 20" fill="none" stroke="currentColor">
   <path
     strokeLinecap="round"
     strokeLinejoin="round"
     strokeWidth={3}
